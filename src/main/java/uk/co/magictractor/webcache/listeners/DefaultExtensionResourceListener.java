 ...
 *
 */
public class DefaultExtensionResourceListener extends AbstractExternalDataResourceListener {

    private final String defaultExtension;

    public DefaultExtensionResourceListener(String defaultExtension) {
    ...
    public void preSaveBody(ExternalDataResource dataResource) {
        dataResource.getProperties().setBodyExtension(defaultExtension);
    }
